...
@pytest.mark.parametrize(
    "ip,expected",
    (["01.100.12.23", True], ["10.000000100.012.023", True], ["1.100.00012.023", True], ["01.0100.012.023", True]),
)
...
@pytest.mark.parametrize(
    "ip,expected",
    (["1.100.12.23", False], ["127.0.0.1", False], ["190.123.34.6", False], ["10129393.24534.24534.346", False]),
)
